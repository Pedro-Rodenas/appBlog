...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header__title { font-size: 2rem; margin-bottom: 6px; letter-spacing: 1px; }
        .header__subtitle { font-size: 1rem; opacity: 0.9; }
        ...
        .post:hover { transform: translateY(-4px); box-shadow: 0 8px 16px rgba(0,0,0,0.15); }

        .post__title { font-size: 1.5rem; color: #005eff; margin-bottom: 8px; }
        .post__content { margin-bottom: 12px; line-height: 1.6; }
        .post__actions { display: flex; align-items: center; gap: 12px; }
        ...
        .btn--edit { background-color: #ffb703; color: white; }
        .btn--edit:hover { background-color: #e09b00; }
                ...
                <article class="post">
                    ...
                    <div class="post__actions">
                        ...
                        <form action="{{ route('posts.destroy', $post) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn--delete" onclick="return confirm('¿Seguro que deseas eliminar este post?')">
